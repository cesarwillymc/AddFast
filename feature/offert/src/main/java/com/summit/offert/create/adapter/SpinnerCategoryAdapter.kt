...
class SpinnerCategoryAdapter(context:Context): BaseAdapter() {
    var inflater: LayoutInflater = LayoutInflater.from(context)
    var lisProducts:List<CategoriasModel> = listOf()
    fun updateData(data: List<CategoriasModel>){
        lisProducts=data
    ...
    override fun getItem(position: Int): CategoriasModel {
