...
object Dependencies {
    ...
    const val FIREBASEREALTIME= "com.google.firebase:firebase-database-ktx:${DependencyVersion.FIREBASEREALTIME}"
    ...
    const val LOGGING = "com.squareup.okhttp3:logging-interceptor:${DependencyVersion.LOGGING}"
