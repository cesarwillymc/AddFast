...
object Dependencies {
    ...
    const val COROUTINESSERVICES="org.jetbrains.kotlinx:kotlinx-coroutines-play-services:${DependencyVersion.COROUTINESANDROID}"
    const val LIFECYCLEKTX="androidx.lifecycle:lifecycle-runtime-ktx:${DependencyVersion.LIFECYCLEKTX}"
    const val COROUTINESANDROID="org.jetbrains.kotlinx:kotlinx-coroutines-android:${DependencyVersion.LIFECYCLEKTX}"
