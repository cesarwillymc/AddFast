...
object Dependencies {
    ...
    const val KOINVM = "org.koin:koin-androidx-viewmodel:${DependencyVersion.KOIN}"
    const val KOINGENERIC = "org.kodein.di:kodein-di-generic-jvm:${DependencyVersion.KOINGENERIC}"
    const val KOINGENERICANDROID = "org.kodein.di:kodein-di-framework-android-x:${DependencyVersion.KOINGENERIC}"
    const val KOINFRAGMENT = "org.koin:koin-androidx-fragment:${DependencyVersion.KOIN}"
